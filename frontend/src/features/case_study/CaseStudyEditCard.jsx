	...
	return (
		<div className="mb-1 px-2 bg-white shadow-md flex">
			<div className="my-2 grid grid-cols-3 gap-2">
				...
				<img src={props.thumbnail&&(backendUrl+props.thumbnail)}  alt="" className="aspect-[4/4]" style={{width:100, height:100, maxWidth:100}}/> 
				...
				<div className="col-span-2 z-40">
					<Link to={link} >
						<div className="text-xs text-gray-400">{props.company}</div>
						
						<div className="font-bold text-base break-words whitespace-pre-wrap mt-2 elp-title">{props.case_study.question}</div>
						<div className="text-gray-400 text-sm break-words whitespace-pre-wrap elp-title2">{props.case_study.content}</div>
